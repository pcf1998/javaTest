...
public class SpanningTree extends Application {
    ...
    public static void PRIM(int[][] graph, int start, int n) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            mins[minV][1] = 0;
            System.out.println("生成树的第" + (i+1) + "条边=<" + (mins[minV][0]+1) + "," + (minV+1) + ">");
    ...
    public void start(Stage primaryStage) {
        ...
        System.out.println("The adjmatrix is :");
        ...
        SpanningTree.PRIM(tree, vertexNumber - vertexNumber, vertexNumber);

        int[][] adjmatrix1 =SpanningTree.result;
